...
import com.cajetanp.youtubeplus.viewmodels.StartViewModel
...
class StartFragment : Fragment(), ContentListAdapter.ListItemClickListener,
    ...
    override fun onCreateOptionsMenu(menu: Menu, inflater: MenuInflater) {
        ...
        searchView.setOnQueryTextFocusChangeListener { _, hasFocus ->
            if (activity != null && activity is InteractionListener)
                (activity as InteractionListener).onSearchFocusChange(hasFocus)
        }
